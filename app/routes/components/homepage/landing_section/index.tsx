...
<div className="container grid grid-rows-2 grid-cols-2 h-full w-full mx-auto">
      <div className="md:w-2/3 h-full col-start-1 row-start-2 col-span-2 flex justify-start items-end p-2">
        <h3 className="w-3/4 text-5xl leading-relaxed text-white pb-10">
