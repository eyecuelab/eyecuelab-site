  ...
  return (
    <>
      <img
        src={video}
        alt="video"
        className="w-full h-full absolute inset-0 bg-cover"
      />
      <div className="absolute inset-0">
        <div className="md:w-[80vw] mx-auto grid grid-rows-2 grid-cols-2 h-full">
          <div className="w-full md:w-2/3 h-full col-start-1 row-start-2 col-span-2 flex justify-start items-end p-3 md:p-0">
